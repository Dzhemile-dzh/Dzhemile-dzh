                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2023/2023-nora.jpg" class="custom-block-image img-fluid" alt=""
                                        style="height: 100%!important;">
                                </div>
                                <span class="badge-sold badgem position-absolute">
                                    <strong><?= $translations['sold'] ?></strong>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['nora_heading'] ?></h2>
                                <p>
                                    <?= $translations['nora_description'] ?>
                                </p>
