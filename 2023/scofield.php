                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2023/2023-h.jpg" class="custom-block-image img-fluid" alt=""
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['scofield_title'] ?></h2>
                                <p>
                                    <?= $translations['scofield_description'] ?>
                                </p>

                                <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                    <div class="row" style="display: contents;">
                                        <p> <strong>
                                                <?= $translations['price'] ?>: <span style="color: #49e98e; font-size: 20px">550<?= $translations['leva'] ?><span>
                                            </strong>
                                        </p>
                                    </div>
