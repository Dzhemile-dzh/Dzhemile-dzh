                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2023/2023-portrait.jpg" class="custom-block-image img-fluid" alt=""
                                        style="height: 100%!important;">
                                </div>
                                <span class="badge-sold badgem position-absolute"><strong><?= $translations['sold'] ?></strong></span>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['portrait_heading'] ?></h2>
                                <p><?= $translations['portrait_description'] ?></p>
                                <div
                                    class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                    <div class="d-flex mb-3 mb-lg-0 mb-md-0">
                                        <p><strong><?= $translations['sold'] ?></strong> <?= $translations['not_available'] ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
