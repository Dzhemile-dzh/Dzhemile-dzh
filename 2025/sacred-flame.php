                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2025/2025-a.jpg" class="custom-block-image img-fluid" alt=""
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['sacred_flame_title'] ?></h2>
                                <p><?= $translations['sacred_flame_description'] ?></p>
