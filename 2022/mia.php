                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2022/2022-a.jpg" class="custom-block-image img-fluid" alt="" style="height: 100%!important;">
                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                <div class="custom-block-top d-flex mb-1">
                                    ...
                                    <small>
                                        <i class="bi-clock-fill custom-icon">2022</i>
                                    </small>
                                ...
                                <h2 class="mb-2"><?= $translations['mia_heading']; ?></h2>
                                <p>
                                    <?= $translations['mia_description'] ?>
                                </p>

                                <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                    <div class="row" style="display: contents;">
                                        <p> <strong>
                                                <?= $translations['price'] ?>: <span style="color: #49e98e; font-size: 20px">600<?= $translations['leva'] ?><span>
                                            </strong>
                                        </p>
                                    </div>
