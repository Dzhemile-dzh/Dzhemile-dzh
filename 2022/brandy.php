                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2022/2022-g.jpg" class="custom-block-image img-fluid" alt="" style="height: 100%!important;">
                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['brandy_heading']; ?></h2>
                                <span class="badge" style="background-color: #0dcaf0; font-size: 14px; margin-top: 8px; margin-bottom: 8px;"><?= $translations['framed'] ?></span>
                                <p>
                                    <?= $translations['brandy_description']['intro'] ?>
                                    <br><?= $translations['brandy_description']['details'] ?>
                                    <br><?= $translations['brandy_description']['atmosphere'] ?>
                                    <br><?= $translations['brandy_description']['conclusion'] ?>
                                    <br><span class="badge" style="background-color: #4107ff; font-size: 16px; margin-top: 8px; margin-bottom: 8px;"><?= $translations['created_by_aykut'] ?></span>
                                </p>
