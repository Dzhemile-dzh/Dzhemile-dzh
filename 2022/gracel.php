                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-icon-wrap">
                                <div class="custom-block-image-wrap custom-block-image-detail-page">
                                    <img src="../images/2022/2022-b.jpg" class="custom-block-image img-fluid" alt=""
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-info">
                                ...
                                <h2 class="mb-2"><?= $translations['gracel_heading'] ?></h2>
                                <p><?= $translations['gracel_description'] ?></p>
                                <div class="profile-block profile-detail-block d-flex flex-wrap align-items-center mt-5">
                                    <div class="d-flex mb-3 mb-lg-0 mb-md-0">
                                        <p><b><?= $translations['sold'] ?> </b><?= $translations['not_available'] ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
